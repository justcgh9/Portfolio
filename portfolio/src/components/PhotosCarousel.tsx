...
const Photos: React.FC<ContentChildrenProps> = ({
  active,
    ...
    <div className={'info ' + (active ? "show" : "hide")} id="info-photo">
      <div className="gallery_cont">
        <div className="flex justify-center items-center gap-[2%] p-0">
          <button
            id="prev_btn"
            className="text-[#F9FBF8] text-[30px] w-[10%] border-none cursor-pointer bg-transparent h-fit-content m-0 z-30"
            onClick={prevPhoto}
          >
            &#10094;
          </button>
